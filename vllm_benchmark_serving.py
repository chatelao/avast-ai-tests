...
import numpy as np
from vllm_backend_request_func import (ASYNC_REQUEST_FUNCS, RequestFuncInput,
                                  RequestFuncOutput)
...
async def benchmark(
    ...
    async def wrapped_request(request_func_input):
        if semaphore:
    ...
    async for request in get_request(input_requests, request_rate):
        ...
        tasks.append(
            asyncio.create_task(
                wrapped_request(request_func_input=request_func_input)))
